...
- 🔬 Deep Research mode — 2x searches, 9-section report, 800+ words
...
FastAPI · LangGraph · LangChain · HuggingFace Inference API · SQLite · JWT · Vanilla JS
